...
3 &	2,34 &	0,35 &	n/a &	18,69 &	0,73 &	0,98 \\
	    ...
	    \end{tabular}
	\label{tab:var1}
	\caption{Měření díly: 3, odpor: 20, nádoba: 54}
	\end{center}
\end{table}
...
3&	2,45&	0,06&	n/a&	18,69&	0,24&	1\\
	    ...
	    \end{tabular}
	\label{tab:var3}
	\caption{Měření díly: 3, odpor: 50, nádoba: 54}
	\end{center}
\end{table}
...
3&	2,44&	0,1&	n/a&	18,69&	0,22&	1\\
	    ...
	    \end{tabular}
       \label{tab:var4}
	\caption{Měření díly: 2, odpor: 50, nádoba: 54}
	\end{center}
\end{table}
...
3&	3,17&	0,06&	n/a&	18,69&	0,54&	0,99\\
	    ...
	    \end{tabular}
\label{tab:var5}
	\caption{Měření díly: 1, odpor: 20, nádoba: 54}
	\end{center}
\end{table}
...
3&	2,77&	0,2&	n/a	&18,69&	0,71&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var6}
	\caption{Měření díly: 1, odpor: 5, nádoba: 54}
	\end{center}
\end{table}
...
3&	3,11&	-0,03&	6,57&	18,69&	0,52&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var7}
	\caption{Měření díly: 2, odpor: 20, nádoba: 54}
	\end{center}
\end{table}
...
3&	3,59&	0,08&	n/a&	18,69&	0,58&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var8}
	\caption{Měření díly:2, odpor: 20, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,88&	0,12&	n/a	&18,69&	0,27&	1	\\
	    ...
	    \end{tabular}
\label{tab:var9}
	\caption{Měření díly:2, odpor: 50, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,25&	0&	n/a&	18,69&	0,75&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var10}
	\caption{Měření díly:2, odpor: 5, nádoba: 35}
	\end{center}
\end{table}
...
3&	3,71&	-0,12&	9,21&	18,69&	0,6&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var12}
	\caption{Měření díly:3, odpor: 20, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,79&	0,07&	n/a&	18,69&	0,29&	0,99\\
	    ...
	    \end{tabular}
\label{tab:var13}
	\caption{Měření díly:3, odpor: 5, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,23&	-0,14&	6,52&	18,69&	0,73&	0,98\\
	    ...
	    \end{tabular}
\label{tab:var15}
	\caption{Měření díly:1, odpor: 5, nádoba: 35}
	\end{center}
\end{table}
...
3&	3,36&	0,02&	n/a &	18,69&	0,55&	0,96\\
	    ...
	    \end{tabular}
\label{tab:var16}
	\caption{Měření díly:1, odpor: 20, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,6 & 	0,08 &	n/a	 & 18,69 &	0,23 &	0,99\\
	    ...
	    \end{tabular}
\label{tab:var17}
	\caption{Měření díly:1, odpor: 50, nádoba: 35}
	\end{center}
\end{table}
...
3&	2,64&	0,13&	n/a	& 18,69	 & 0,22	& 1\\
	    ...
	    \end{tabular}
\label{tab:var18}
	\caption{Měření díly:1, odpor: 50, nádoba: 54}
	\end{center}
\end{table}
...
3 &	2,72&	0,28&	n/a	&18,69&	0,72&	0,97\\
	    ...
	    \end{tabular}
\label{tab:var19}
	\caption{Měření díly:2, odpor: 5, nádoba: 54}
	\end{center}
\end{table}
